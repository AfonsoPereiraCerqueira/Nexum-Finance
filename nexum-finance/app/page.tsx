        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="z-10 space-y-8 text-center lg:text-left">
            ...
            <p className="text-gray-400 text-lg md:text-xl max-w-xl mx-auto lg:mx-0 font-sans leading-relaxed">
              Take control of your wealth with high-yield accounts, instant
              global transfers, and AI-driven investment insights. Simple,
              secure, and built for you.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link href="/register" className="bg-emerald-500 text-black px-8 py-4 rounded-xl font-bold text-lg hover:bg-emerald-400 hover:scale-105 transition-all shadow-[0_0_20px_rgba(16,185,129,0.3)]">
                Get Started Now
              </Link>
              <Link href="/pricing" className="border border-white/10 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-white/5 transition-all">
                  View Pricing
              </Link>
            </div>

            <div className="space-y-4">
              <p className="text-xs font-bold tracking-widest text-emerald-500/60 uppercase">
                Our Ecosystem
              </p>
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-4">
                ...
                <div className="flex items-center gap-2 bg-white/5 border border-white/10 px-4 py-2 rounded-full backdrop-blur-sm">
                  ...
                  <span className="text-xs font-medium text-gray-300">
                    Standard: <span className="text-white">€0/mo</span>
                  </span>
                </div>

                {/* Resumo do Premium (Destaque) */}
                <div className="flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/30 px-4 py-2 rounded-full backdrop-blur-sm">
                  ...
                  <span className="text-xs font-medium text-emerald-400">
                    Premium: <span className="text-white">€9.90/mo</span>
                  </span>
                </div>
                ...
                <div className="flex items-center gap-2 bg-white/5 border border-white/10 px-4 py-2 rounded-full backdrop-blur-sm">
                  ...
                  <span className="text-xs font-medium text-gray-300">
                    Black: <span className="text-white">€24.90/mo</span>
                  </span>
                </div>
              </div>
            </div>
            ...
            {/* Mini Stats */}
            <div className="pt-8 flex justify-center lg:justify-start gap-8 border-t border-white/5 border-b pb-8">
              <div>
          ...
          <div className="relative flex justify-center items-center">
            ...
            <div className="relative z-10 w-full max-w-[400px] aspect-[1.58/1] bg-gradient-to-br from-zinc-800 to-black border border-white/10 rounded-2xl p-8 shadow-2xl rotate-3 hover:rotate-0 transition-transform duration-700 ease-out group overflow-hidden">
              ...
              <div className="flex justify-between items-start mb-12">
                <div className="w-12 h-10 bg-zinc-700/50 rounded-md" />{" "}
                {/* Chip */}
                <div className="text-emerald-500 font-bold italic text-xl">
                  NEXUM
                </div>
              </div>
